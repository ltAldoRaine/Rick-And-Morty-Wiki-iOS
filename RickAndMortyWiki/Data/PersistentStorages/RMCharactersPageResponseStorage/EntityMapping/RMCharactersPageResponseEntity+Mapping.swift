...
extension RMCharacterResponseEntity {
    func toDTO() -> RMCharactersPageResponseDTO.RMCharacterDTO? {
        ...
        return .init(
            ...
            origin: RMCharactersPageResponseDTO.RMCharacterDTO.RMCharacterOriginDto(name: origin, url: origin),
            location: RMCharactersPageResponseDTO.RMCharacterDTO.RMCharacterLocationDto(name: location, url: location),
            image: image,
            episode: episode,
            url: url,
            created: created
